...
const skills = [
    {
        ...
        technologies: [
            ...
            { name: 'Tailwind Css', icon: <RiTailwindCssFill className='text-green-500' /> },
        ],
    },

    {
        ...
        technologies: [
            ...
            { name: 'React', icon: <DiReact className='text-cyan-600' /> },
...
function Skills() {
  return (
      <div className="max-w-[650px] mx-auto flex flex-col justify-center px-4 text-gray-200 pb-8 md:py-12" id='skills'>
        <Reveal>
          <h2 className="text-3xl font-bold mb-4 text-center uppercase">Skills</h2>
        <p className='text-center mb-8'>
              I worked on various frontend and projects. Check them <a href="#" className="underline">there</a>.
        </p>
